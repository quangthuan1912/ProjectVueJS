<template>
    ...
    <div class="container">
      <div class="row">
        <div
          ...
          :style="{
            'background-image':
              'url(' + require('../../src/assets/images/about.jpg') + ')',
          }"
        ></div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-1.jpg') + ')',
              }"
            ></div>
            <h3>Brandy</h3>
          </div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-2.jpg') + ')',
              }"
            ></div>
            <h3>Gin</h3>
          </div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-3.jpg') + ')',
              }"
            ></div>
            <h3>Rum</h3>
          </div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-4.jpg') + ')',
              }"
            ></div>
            <h3>Tequila</h3>
          </div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-5.jpg') + ')',
              }"
            ></div>
            <h3>Vodka</h3>
          </div>
        ...
        <div class="col-lg-2 col-md-4">
          <div class="sort w-100 text-center">
            <div
              ...
              :style="{
                'background-image':
                  'url(' + require('../../src/assets/images/kind-6.jpg') + ')',
              }"
            ></div>
            <h3>Whiskey</h3>
          </div>
  ...
  <section
    class="ftco-section testimony-section img mt-16"
    :style="{
      'background-image':
        'url(' + require('../../src/assets/images/bg_4.jpg') + ')',
    }"
  >
    <div class="overlay"></div>
    <div class="container">
                  ...
                  <div class="d-flex align-items-center">
                    <div
                      ...
                      :style="{
                        'background-image':
                          'url(' +
                          require('../../src/assets/images/person_1.jpg') +
                          ')',
                      }"
                    ></div>
                    <div class="pl-3">
                  ...
                  <div class="d-flex align-items-center">
                    <div
                      ...
                      :style="{
                        'background-image':
                          'url(' +
                          require('../../src/assets/images/person_3.jpg') +
                          ')',
                      }"
                    ></div>
                    <div class="pl-3">
                  ...
                  <div class="d-flex align-items-center">
                    <div
                      ...
                      :style="{
                        'background-image':
                          'url(' +
                          require('../../src/assets/images/person_2.jpg') +
                          ')',
                      }"
                    ></div>
                    <div class="pl-3">
  ...
  >
    <div class="container">
      <div class="row">
        <div
          class="col-md-6 col-lg-3 justify-content-center counter-wrap"
        >
...
export default {
  ...
  components: { SideBar, FooterF, SectionIntro },
};
</script>
